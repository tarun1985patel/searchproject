 ...
 */
 //8
class MageWorx_SearchAutocomplete_Model_Resource_Fulltext extends Mage_CatalogSearch_Model_Resource_Fulltext
{
    /**
	   ...
	   $adapter = $this->_getWriteAdapter();
	    if (!$query->getIsProcessed()) {
           ...
           $preparedTerms = Mage::getResourceHelper('catalogsearch')
            ...
            if ($searchType == Mage_CatalogSearch_Model_Fulltext::SEARCH_TYPE_LIKE
                ...
                //foreach ($words as $word) {
                    $like[] = $helper->getCILike('s.data_index', implode(" ",$words), array('position' => 'any'));
                //}
            ...
            if ($searchType == Mage_CatalogSearch_Model_Fulltext::SEARCH_TYPE_FULLTEXT
				...
				//echo $bind[':query'] = '" '.substr(str_replace('"',"", implode(' ', $preparedTerms[0])),1).' "';
           ...
           $sql = $adapter->insertFromSelect($select,
			...
			$query = 'SELECT id FROM search_cache where query_text="'.$query_text.'"';
