...
class MageWorx_SearchAutocomplete_Model_Mysql4_Fulltext extends Mage_Core_Model_Mysql4_Abstract {
    ...
    protected function _getSearchableBlogPages() {
        if ((string)Mage::getConfig()->getModuleConfig('AW_Blog')->active!='true') return null;        
        $select = $this->_getReadAdapter()->select()
    ...
    public function resetSearchResults() {
        ...
        try {
            ...
            $this->_getWriteAdapter()->query("TRUNCATE TABLE {$this->getTable('searchautocomplete/result')}");
